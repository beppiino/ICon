...
def plot_results(classifier,X_test,y_test, name):
    ...
    print("dd",classification_report(y_test, pred)) 
...
grid_svm.fit(X_train.astype(str), y_train.astype(str)) 
...
grid_rf.fit(X_train.astype(str), y_train.astype(str))
...
grid_knn.fit(X_train.astype(str), y_train.astype(str))
...
Ada.fit(X_train.astype(str), y_train.astype(str))
...
plot_results(gaussian, X_test, y_test,'Naive Bayes Gaussian')